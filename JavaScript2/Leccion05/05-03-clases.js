...
// let persona3 = new Persona('Carla', 'Ponce'); No se permite antes de crear la clase
...
persona2.apellido = 'Croft';
console.log(persona2.apellido);

let empleado1 = new Empleado('María', 'Gimenez', 'Sistemas');
console.log(empleado1);
console.log(empleado1.nombreCompleto()); //hereda el método de la clase padre
...
let persona3 = new Persona('Carla', 'Gimenez');
